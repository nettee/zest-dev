---
description: Run all workflow stages end-to-end for simple tasks with approval checkpoints
...
# Zest Dev: End-to-End Workflow for Simple Tasks

Run through all workflow stages — research, design, implement, and final review — in a single command. Suitable for straightforward, well-scoped tasks.
...
- **Always starts fresh**: This command creates a new spec from scratch. Use individual stage commands to continue partial work.
